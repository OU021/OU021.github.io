...
<header class="site-header"><nav class="navigation shell" aria-label="Main navigation"><a class="wordmark" href="${home}" aria-label="Zhilin Ou"><img class="brand-mark" src="${base}assets/baymax-camera.svg?v=${revision('baymax-camera.svg')}" width="48" height="48" alt="Baymax holding a camera" aria-hidden="true"><span class="wordmark-name">Zhilin Ou<span class="wordmark-dot" aria-hidden="true">.</span></span></a><div class="nav-links">${navItems.map(n=>`<a href="${home}#${n.toLowerCase()}">${n}</a>`).join('')}<details><summary>More</summary><div class="dropdown"><a href="${home}photography/"${path==='photography/'?' aria-current="page"':''}>${icon('camera')}Photography</a></div></details></div></nav></header>
